...
export const earningRules: EarningRule[] = [
  ...
  earn("earn-log-week", "Clean material/tool logging week (no corrections)", 40, "warehouse", 40, true),
  earn("earn-tools", "All tools returned, none damaged (weekly)", 30, "warehouse", 30, true),
  earn("earn-daily", "Daily value ritual", 5, "crew", 150, true),
  earn("earn-weekly", "Weekly value exercise", 5, "crew", 80, true),
  earn("earn-monthly", "Monthly value ritual", 5, "crew", 60, true),
...
export function createSeedState(): CrewState {
  return {
    ...
    pointsEvents: [
      ...
      { id: "pe-google-jordan-todo-2026-07", userId: "u6", type: "crew_google_review", points: 200, reason: "TODO_CONFIRM seeded 5-star Google review for Jordan; defaulted to Jordan Thorpe", ref: "google_seed:TODO_CONFIRM_JORDAN_THORPE:u6:2026-07", ts: "2026-07-29T10:10:00-07:00", source: "crew" },
    ],
    walletConfig: { rewardDollarPerPoint: crewConfig.pointsAnchor, weeklyHabitCap: 300 },
    rewards,
    redemptions: [],
    ritualCompletions: [],
    reviews: [
