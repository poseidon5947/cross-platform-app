...
**Anchor:** confirmed at **1 point = $0.25 of reward value**. The catalog is now restricted to Cash, Gift Card, and PTO rewards, with $50 around 200 points and $100 around 400 points.

### How points are earned

| Action | Points | Source app |
|---|---:|---|
| Perfect daily truck-task day | +25 | Waterproofing+ |
| 5-day truck-task streak bonus | +25 | Waterproofing+ |
| SOP created and approved | +20 | SOP+ |
| Daily value ritual | +5 | Crew+ |
| Weekly value exercise | +5 | Crew+ |
| Monthly value ritual | +5 | Crew+ |
| Safety milestone | +5 | Crew+ |
| Peer recognition received | +5 | Crew+ |
