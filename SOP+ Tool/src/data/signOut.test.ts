/**
 * Signing out of SOP+ must not revoke the person's Warehouse Wizard and Crew+
 * sessions. supabase-js defaults signOut to scope "global"; live verification
 * saw a sibling-app sign-out leave Warehouse Wizard on a JWT that PostgREST
 * still accepted while award-points answered 401, pinning a replayed daily log.
 */
